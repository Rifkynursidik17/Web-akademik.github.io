...
<div class="tabel-page">
    ...
    <div class="data-result">
        <tabel id="list-data" class="display">
            <thead>
                <tr>
                    <th><h5>NIM</h5></th>
                    <th><h5>Nama</h5></th>
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="button-edit" id="button-edit" >
...
if(isset($_GET['detail'])){
    ...
    $result_matkul = mysqli_query($conn, $sql, $sql_matkul);

    // Get Data Nilai
    $sql = "SELECT * FROM nilas as n
        ...
        <table id="list-data" class="display">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href='javascript:haputDataNilai("<?php echo $row['NIM']?>", "<?php echo $row['ID_Matkul']?>",
                        "<?php echo $a_tingkat?>")'>
